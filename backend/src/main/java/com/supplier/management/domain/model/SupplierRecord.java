...
public class SupplierRecord {
     ...
     *
     * @throws com.supplier.management.domain.exception.SupplierNotRestrictableException if
     *     {@code status != ACTIVE}
     */
     ...
     *
     * @throws com.supplier.management.domain.exception.SupplierNotPromotableException if
